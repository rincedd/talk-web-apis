...
import { Appear, CodePane, CodeSpan, Deck, FlexBox, Heading, Image, Link, ListItem, Slide, Text, UnorderedList } from "spectacle";
// @ts-ignore
...
import { DeckTemplate } from "./slide-template";
...
export class Presentation extends React.Component {
  render() {
    return (
      <ClientManagerContext.Provider value={clientManager}>
